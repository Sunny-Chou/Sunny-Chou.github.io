...
public class App3 extends Thread{
    ...
    String addrs;
    reply rp;
    public App3(String[] msgs,reply rp,String subject,String addrs){
        this.msgs=msgs;
        this.email_addr=rp.getemail_addr();
        this.email_password=rp.getemail_password();
        this.smtp_port=rp.getsmtp_port();
        this.smtp_server=rp.getsmtp_server();
        this.smtp_jiami=rp.getsmtp_jiami();
        this.rp=rp;
        this.addrs=addrs;
    ...
    public boolean resultCheck(Socket smtp,BufferedReader smtp_in,PrintWriter smtp_out,int success_code,String message)throws IOException{
        ...
        return false;
            ...
            rp.getcmd().setText("訊息：執行"+message+"時發生錯誤");
            return true;
    ...
    public void send() throws IOException {
        try {
            ...
            if (smtp_jiami.equals("STARTTLS")) {
                ...
                if (sendCommandAndResultCheck(smtp2, smtp_in, smtp_out, "RCPT TO:<" + addrs + ">", 250, "指定郵件收信人")) {
                    throw new SocketException();
                }
                ...
                if (sendCommandAndResultCheck(smtp, smtp_in, smtp_out, "RCPT TO:<" + addrs + ">", 250, "指定郵件收信人")) {
                    throw new SocketException();
                }
    ...
    public void auth(String s, Socket smtp, BufferedReader smtp_in, PrintWriter smtp_out) throws IOException {
        ...
        if (smtp_server != null) {
            ...
            try {
                ...
                rp.getcmd().setText("訊息：執行驗證輸入帳號或密碼時發生錯誤");
                throw new SocketException();
            }
        }
    }
