...
public class App2 extends Thread{
    ...
    String[]addrs;
    forward fr;
    public App2(String[] msgs,forward fr,String subject,String[]addrs){
        this.msgs=msgs;
        this.email_addr=fr.getemail_addr();
        this.email_password=fr.getemail_password();
        this.smtp_port=fr.getsmtp_port();
        this.smtp_server=fr.getsmtp_server();
        this.smtp_jiami=fr.getsmtp_jiami();
        this.fr=fr;
        this.addrs=addrs;
    ...
    public boolean resultCheck(Socket smtp,BufferedReader smtp_in,PrintWriter smtp_out,int success_code,String message)throws IOException{
        ...
        return false;
            ...
            fr.getcmd().setText("訊息：執行"+message+"時發生錯誤");
            return true;
    ...
    public void auth(String s, Socket smtp, BufferedReader smtp_in, PrintWriter smtp_out) throws IOException {
        ...
        if (smtp_server != null) {
            ...
            try {
                ...
                fr.getcmd().setText("訊息：執行驗證輸入帳號或密碼時發生錯誤");
                throw new SocketException();
            }
        }
    }
