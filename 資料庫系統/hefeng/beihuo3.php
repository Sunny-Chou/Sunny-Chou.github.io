...
<html> 
    ...
    <body>
        <main>
            <form name="form" method="post" action="beihuo4.php">
            <?php
            session_start ();
            ...
            echo "</p><br>";
            echo "<div><input type='submit' value='備貨完成' name='a' onclick=",'"',"document.forms['form'].a.value='",$_POST['a'],"';",'"',"></div>";
        ?>
        </form>
        <div><form name="form2" method="post" action="beihuo2.php">
