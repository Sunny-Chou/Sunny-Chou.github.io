...
<html>
  ...
  <body>
    ...
    <section>
            ...
            <h2 style="text-align:center;font-size: 150%; color: Navy; font-family: 標楷體">訂購人資訊</h2>
            <input type="button" style="align-items: center;" value="新增店家資訊" class="addStore" ><br><br><br>
            <form action="addNewClient.php" method="POST">
            <div id="div店家名稱" style="display:none;"><label>店家名稱<input type="text" name="storeName"></label></div>
            <div id="div店家地址" style="display:none;"><label>店家地址<input type="text" name="address"></label></div>
            <div id="div聯絡人員姓名" style="display:none;"><label>聯絡人員姓名<input type="text" name="name"></label></div>
            <div id="div聯絡電話" style="display:none;"><label>聯絡電話<input type="text" name="phone"></label></div><br>
            <div id="div新增按鈕" style="display:none;"><input type="submit" style="align-items: center;" value="確定新增" class="addStoreBtn"><br></div>
            <script>
               //addEventListener效果
              var btn = document.querySelector(".addStore");
              btn.addEventListener(
               "click",
               function () {
                document.getElementById("div店家名稱").style.display = 'block';
                document.getElementById("div店家地址").style.display = 'block';
                document.getElementById("div聯絡人員姓名").style.display = 'block';
                document.getElementById("div聯絡電話").style.display = 'block';
                document.getElementById("div新增按鈕").style.display = 'block';
                },
                false
              );
            </script><br>
            ...
            <label>選擇店家<input list="mc" name="clientSelection" /></label>
            <datalist id="mc">
            <?php
