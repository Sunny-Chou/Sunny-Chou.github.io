...
<html> 
    ...
    <main>
        <form name="form" method="post" action="gors2.php">
            <input type="hidden" name="act">
            <?php
                echo "<input type='hidden' name='",$_POST['a'],"'value='",$_POST['a'],"'>";
                echo "<input type='submit' value='刪除'onclick=",'"',"document.forms['form'].act.value='shan';",'"',">";                $g=mysqli_query ( $con,"select * from 商品 where 供貨廠商!='鑫旺免洗餐具行豐原營業處';");
                $ga=mysqli_fetch_array($g);
                $i=1;
                $j=0;
                ...
                echo "<br><input type='submit' name = 'a' value='更改'onclick=",'"',"document.forms['form'].act.value='gai';",'"',">";
            ?><br>
        </form>
        <form name="form2" method="post" action="gaiorshan1.php">
