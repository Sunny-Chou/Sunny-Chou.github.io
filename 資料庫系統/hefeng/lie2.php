...
<html> 
    ...
    <body>
        <main>
            ...
            if(!isset($_POST['mc'])){
                mysqli_close ( $con );
                echo "<script>window.location.href='lie.php'</script>";
            }
            if($_POST['mc']=="選擇店家"){
                ...
                if($a1){
                    ...
                    echo "<form name='form' method='post' action='lie3.php'><select name='a'>";
                    while($a1){
                ...
                $a = mysqli_query ( $con,"select * from 訂單 where 店家名稱='{$_POST['mc']}' and 訂單備貨狀態=1 and 訂單狀態=0;");
                $a1=mysqli_fetch_array($a);
                if($a1){
                    ...
                    while($a1){
                        ...
                        echo "</select><input type='submit' value='選擇'>";
                }else{
        ...
        <form name="form2" method="post" action="lie.php">
